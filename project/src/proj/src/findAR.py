...
class ARFinder():
    ...
    def spin(self):
        print("I am spinning")
        q_rot = quaternion_from_euler(0, 0, 4 * np.pi / 9)
        goal = MoveBaseGoal()
    ...
    def findAR(self):
        ...
        try:
            ...
            #self.requestInstruction():
                #we need to call the Request New Alarm here
                #...maybe send a boolean back or something to trigger it?
            return False
